...
void mapgen_function_builtin::generate( map *m, const oter_id &o, const mapgendata &mgd, int i,
                                        float d )
{
    ( *fptr )( m, o, mgd, i, d );
}
...
#ifndef LUA
int lua_mapgen( map *m, const oter_id &id, const mapgendata &md, int t, float d,
                const std::string & )
{
...
|-----|--|-..-|--|--|--|\n",
                                                mapf::ter_bind( "b l A r d C h 6 x g G , . - | + D t c S T", t_rock_floor, t_rock_floor, t_floor,
                                                        ...
                                                        t_reinforced_glass, t_reinforced_glass, t_floor_blue, t_rock_floor, t_concrete_wall,
                                                        t_concrete_wall,
...
|--------|-..-|--------|\n",
                ...
                const auto predicate = [this]( const tripoint & p ) {
                    return ter( p ) == t_rock_floor || has_furn( p );
                };
                ...
                if( terrain_type == "lab_stairs" || terrain_type == "ice_lab_stairs" ) {
                    ...
                    case 2: // tic-tac-toe # layout
                        ...
                        science_room( this, SEEX + 4, SEEY + 4, SEEX * 2 - 1 - rw, SEEY * 2 - 1 - bw,
                                      zlevel, 3 * rng( 0, 1 ) );
                        if( rw == 1 ) {
                            ter_set( SEEX * 2 - 1, SEEY - 1, t_door_metal_c );
                            ter_set( SEEX * 2 - 1, SEEY, t_door_metal_c );
...
---------|-++-|--------|\n",
                                                        mapf::ter_bind( "D l H O f A r d C h 6 x g G , . - | + D t c ^ w W e E % T S =",
                                                                ...
                                                                t_rock_blue, t_rock_floor, t_concrete_wall, t_concrete_wall, t_door_metal_c, t_door_metal_locked,
                                                                t_floor,
...
-----------++----------|\n",
        ...
        line( this, t_chainfence_v,            0,            0,            0, SEEY * 2 - 1 );
            ...
            case 4: { // Amigara fault
                ...
                switch( random_entry( face ) ) {
                    case NORTH:
                        ...
                        break;
                    case EAST:
                        square( this, t_rock, SEEX * 2 - 5, 0, SEEX * 2 - 1, SEEY * 2 - 1 );
