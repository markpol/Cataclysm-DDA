...
void add_requirements( requirement_data &existing_requirements, const std::vector<std::pair<requirement_id, int>> &new_requirements )
{
    existing_requirements = std::accumulate( new_requirements.begin(), new_requirements.end(), existing_requirements,
