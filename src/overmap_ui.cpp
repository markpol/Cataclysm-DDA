           ...
           const draw_data_t &data )
{
    ...
    if( inp_ctxt != nullptr ) {
        ...
        print_hint( "TOGGLE_ALT_MAP_KEY", uistate.overmap_alt_map_key ? c_pink : c_magenta );
...
tripoint display( const tripoint &orig, const draw_data_t &data = draw_data_t() )
{
    ...
    ictxt.register_action( "TOGGLE_ALT_MAP_KEY" );
    ...
    do {
        ...
        } else if( action == "TOGGLE_ALT_MAP_KEY" ) {
            uistate.overmap_alt_map_key = !uistate.overmap_alt_map_key;
