...
class uistatedata
{
    ...
    public:
        ...
        bool overmap_alt_map_key = false;       // enable alt map key for overmap terrains
        ...
        */
        ...
        void serialize( JsonStream &json ) const {
            ...
            json.member( "overmap_alt_map_key", overmap_alt_map_key );
        ...
        void deserialize( JsonStream &jsin ) {
            ...
            jo.read( "overmap_alt_map_key", overmap_alt_map_key );
