...
void mission_start::place_dog( mission *miss )
{
    ...
    tinymap doghouse;
    doghouse.load( house.x * SM_IN_OMT, house.y * SM_IN_OMT, house.z, false );
...
void mission_start::place_zombie_mom( mission *miss )
{
    ...
    tinymap zomhouse;
    zomhouse.load( house.x * SM_IN_OMT, house.y * SM_IN_OMT, house.z, false );
...
void mission_start::place_bandit_cabin( mission *miss )
{
    ...
    tinymap cabin;
    cabin.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
...
void mission_start::place_informant( mission *miss )
{
    ...
    tinymap bay2;
    bay2.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
...
void mission_start::place_grabber( mission *miss )
{
    ...
    tinymap there;
    there.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
...
void mission_start::place_bandit_camp( mission *miss )
{
    ...
    tinymap bay1;
    bay1.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
...
void mission_start::place_jabberwock( mission *miss )
{
    ...
    tinymap grove;
    grove.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
...
void mission_start::kill_horde_master( mission *miss )
{
    ...
    tinymap tile;
    tile.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
...
void mission_start::place_npc_software( mission *miss )
{
    ...
    tinymap compmap;
    compmap.load( place.x * SM_IN_OMT, place.y * SM_IN_OMT, place.z, false );
    tripoint comppoint;
...
void mission_start::place_deposit_box( mission *miss )
{
    ...
    tinymap compmap;
    compmap.load( site.x * SM_IN_OMT, site.y * SM_IN_OMT, site.z, false );
    std::vector<tripoint> valid;
    for( int x = 0; x < SM_WIDTH; x++ ) {
        for( int y = 0; y < SM_HEIGHT; y++ ) {
