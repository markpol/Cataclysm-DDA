...
-(void)initializeViewComponents{
    ...
    NSString *skipString = NSLocalizedString(@"Play", nil);
    ...
    {
        kSkipButtonFont = [UIFont boldSystemFontOfSize:14];
    }
    ...
    {
        kSkipButtonFont = [UIFont boldSystemFontOfSize:48];
    }
    else
    {
        kSkipButtonFont = [UIFont boldSystemFontOfSize:24];
    ...
    self.LeftSkipButton.frame = CGRectMake(10, self.frame.size.height - 44, skipStringWidth*4, 37);
    self.LeftSkipButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    [self.LeftSkipButton setTitle:@"Sound Pack" forState:UIControlStateNormal];
    
    
    [self.LeftSkipButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.LeftSkipButton setTitleColor:[UIColor grayColor] forState:UIControlStateHighlighted];
    [self.LeftSkipButton.titleLabel setFont:kSkipButtonFont];
    [self.LeftSkipButton addTarget:self action:@selector(didPressBuyButton) forControlEvents:UIControlEventTouchUpInside];
    //[self.LeftSkipButton setBackgroundColor:[UIColor colorWithWhite:0.5 alpha:0.5]];
    [self addSubview:self.LeftSkipButton];
    
    //Right Skip Button
    self.RightSkipButton = [UIButton buttonWithType:UIButtonTypeCustom];
    self.RightSkipButton.frame = CGRectMake(self.frame.size.width - skipStringWidth - kLeftRightSkipPadding, self.frame.size.height - 44, skipStringWidth, 37);
    self.RightSkipButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    [self.RightSkipButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.RightSkipButton setTitleColor:[UIColor grayColor] forState:UIControlStateHighlighted];
...
- (void)didPressBuyButton {
    if ([(id)delegate respondsToSelector:@selector(didPressBuyButton)]) {
