...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message buttonTitles:(NSArray *)buttonTitles buttonStyle:(JGActionSheetButtonStyle)buttonStyle {
    ...
    {
        kTitleFont = [UIFont boldSystemFontOfSize:18];
    }
    ...
    {
        kTitleFont = [UIFont boldSystemFontOfSize:32];
    }
...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message contentView:(UIView *)contentView {
    ...
    if (self) {
        ...
        if (message) {
            ...
            messageLabel.backgroundColor = [UIColor clearColor];
            messageLabel.textAlignment = NSTextAlignmentCenter;
            messageLabel.font = kDescriptionFont;
            messageLabel.textColor = [UIColor blackColor];
            messageLabel.numberOfLines = 0;
...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    if ( ( [SDVersion deviceSize] == Screen4inch ) || ( [SDVersion deviceVersion] == iPhone5 ) || ( [SDVersion deviceVersion] == iPhone5S ) )
    {
        kTitleFont = [UIFont systemFontOfSize:16];
    }
    else if ( ( [SDVersion deviceSize] == Screen3Dot5inch ) || ( [SDVersion deviceVersion] == iPhone4S ) )
    {
        kTitleFont = [UIFont systemFontOfSize:14];
    }
    else if ( ( [SDVersion deviceSize] == Screen4Dot7inch ) || ( [SDVersion deviceVersion] == iPhone6 ) || ( [SDVersion deviceVersion] == iPhone6S ) )
    {
        kTitleFont = [UIFont systemFontOfSize:18];
    }
    else if ( ( [SDVersion deviceSize] == Screen5Dot5inch ) || ( [SDVersion deviceVersion] == iPhone6Plus ) || ( [SDVersion deviceVersion] == iPhone6SPlus ) )
    {
        kTitleFont = [UIFont systemFontOfSize:20];
    }
    else if( [SDVersion deviceVersion] == iPad2 )
    {
    ...
    if (buttonStyle == JGActionSheetButtonStyleDefault) {
        ...
        backgroundColor = [UIColor colorWithRed:0.25 green:0.25 blue:0.25 alpha:0.5];
        borderColor = [UIColor colorWithRed:0.5 green:0.5 blue:0.5 alpha:1.0];
    }
